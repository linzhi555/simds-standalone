...
// Net 提供模拟的网络接口
func (o *MockOs) Net() core.NetInterface {
	return o.net
}
...
type MockNetCard struct {
	Addr string
	In   *core.Vec[core.Message]
	Out  *core.Vec[core.Message]
}
...
// Recv 实现NetInterface
func (card MockNetCard) Recv() (core.Message, error) {
	return card.In.Dequeue()
}

// Send 实现NetInterface
func (card MockNetCard) Send(m core.Message) error {
	card.Out.InQueue(m)
	return nil
}
